...
#--------------------------------------------------------------------------------
f.write("set output 'cost.eps'\n")
f.write("set multiplot\n")  
f.write("set pointsize 0.4\n")

f.write("set xlabel 'iteration' offset 0,0\n")
f.write("set ylabel 'cost' offset 2,0\n")
...
#------------------------------------------------------------------------------
   ...
   #f.write("plot 'H0.dat' u 1:2 w lp notitle dt 2 pt 7 lt 1 lc rgb 'black' \n")
    ...
    if i==0:
        f.write("plot 'cost/cost_100_00_00_10.dat' u 1:2 w p t 'nb=0' ls 6,\\\n")
        f.write("'cost/cost_100_00_06_10.dat' u 1:2 w l t '6' ls 2,\\\n")
        f.write("'cost/cost_100_00_08_10.dat' u 1:2 w l t '8' ls 3,\\\n")
        f.write("'cost/cost_100_00_10_10.dat' u 1:2 w l t '10' ls 4,\\\n")
        f.write("'cost/cost_100_00_12_10.dat' u 1:2 w l t '12' ls 5,\\\n")
        f.write("'cost/cost_100_00_14_10.dat' u 1:2 w l t '14' ls 11,\\\n")
        f.write("'cost/cost_100_00_16_10.dat' u 1:2 w l t '16' ls 12,\\\n")
        f.write("'cost/cost_100_00_18_10.dat' u 1:2 w l t '18' ls 13,\\\n")
        f.write("'cost/cost_100_00_20_10.dat' u 1:2 w l t '20' ls 14,\\\n")
        f.write("'cost/cost_100_00_22_10.dat' u 1:2 w l t '22' ls 15\n")

    if i==1:
        f.write("plot 'cost/cost_100_00_00_10.dat' u 1:3 w p t 'nb=0' ls 6,\\\n")
        f.write("'cost/cost_100_00_06_10.dat' u 1:3 w l t '6' ls 2,\\\n")
        f.write("'cost/cost_100_00_08_10.dat' u 1:3 w l t '8' ls 3,\\\n")
        f.write("'cost/cost_100_00_10_10.dat' u 1:3 w l t '10' ls 4,\\\n")
        f.write("'cost/cost_100_00_12_10.dat' u 1:3 w l t '12' ls 5,\\\n")
        f.write("'cost/cost_100_00_14_10.dat' u 1:3 w l t '14' ls 11,\\\n")
        f.write("'cost/cost_100_00_16_10.dat' u 1:3 w l t '16' ls 12,\\\n")
        f.write("'cost/cost_100_00_18_10.dat' u 1:3 w l t '18' ls 13,\\\n")
        f.write("'cost/cost_100_00_20_10.dat' u 1:3 w l t '20' ls 14,\\\n")
        f.write("'cost/cost_100_00_22_10.dat' u 1:3 w l t '22' ls 15\n")
