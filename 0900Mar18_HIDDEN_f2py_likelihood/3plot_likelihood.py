...
#------------------------------------------------------------------------------
   ...
   #f.write("plot 'H0.dat' u 1:2 w lp notitle dt 2 pt 7 lt 1 lc rgb 'black' \n")
    ...
    if i==0:
        f.write("plot 'cost/cost_20_06_00_01.dat' u 1:6 w p t 'nb=0' ls 6,\\\n")
        f.write("'cost/cost_20_06_02_01.dat' u 1:6 w l t '2' ls 1,\\\n")
        f.write("'cost/cost_20_06_04_01.dat' u 1:6 w l t '4' ls 2,\\\n")
        f.write("'cost/cost_20_06_06_01.dat' u 1:6 w l t '6' ls 3,\\\n")
        f.write("'cost/cost_20_06_08_01.dat' u 1:6 w l t '8' ls 4,\\\n")
        f.write("'cost/cost_20_06_10_01.dat' u 1:6 w l t '10' ls 5\n")
