...
#------------------------------------------------------------------------------
   ...
   if i==0:
      ...
      f.write("plot 'MSEfinal_40_10.dat' u 1:2 w l t '1 by 1' ls 1,\\\n")
      f.write("'MSEfinal_40_10_para.dat' u 1:2 w l t 'parallel' ls 2\n")

   if i==1:
      f.write("set title 'obs-obs'\n")
      f.write("plot 'MSEfinal_40_10.dat' u 1:4 w l notitle ls 1,\\\n")
      f.write("'MSEfinal_40_10_para.dat' u 1:4 w l notitle ls 2\n")

   if i==2:
      f.write("set title 'hidden-obs'\n")
      f.write("plot 'MSEfinal_40_10.dat' u 1:6 w l notitle ls 1,\\\n")
      f.write("'MSEfinal_40_10_para.dat' u 1:6 w l notitle ls 2\n")

   if i==3:
      f.write("set title 'obs-hidden'\n")
      f.write("plot 'MSEfinal_40_10.dat' u 1:8 w l notitle ls 1,\\\n")
      f.write("'MSEfinal_40_10_para.dat' u 1:8 w l notitle ls 2\n")

   if i==4:
      f.write("set title 'hidden-hidden'\n")
      f.write("plot 'MSEfinal_40_10.dat' u 1:10 w l notitle ls 1,\\\n")
      f.write("'MSEfinal_40_10_para.dat' u 1:10 w l notitle ls 2\n")

   if i==5:
      f.write("set title 'all'\n")
      f.write("plot 'MSEfinal_40_15.dat' u 1:2 w l t '1 by 1' ls 1,\\\n")
      f.write("'MSEfinal_40_15_para.dat' u 1:2 w l t 'parallel' ls 2\n")

   if i==6:
      f.write("set title 'obs-obs'\n")
      f.write("plot 'MSEfinal_40_15.dat' u 1:4 w l notitle ls 1,\\\n")
      f.write("'MSEfinal_40_15_para.dat' u 1:4 w l notitle ls 2\n")

   if i==7:
      f.write("set title 'hidden-obs'\n")
      f.write("plot 'MSEfinal_40_15.dat' u 1:6 w l notitle ls 1,\\\n")
      f.write("'MSEfinal_40_15_para.dat' u 1:6 w l notitle ls 2\n")

   if i==8:
      f.write("set title 'obs-hidden'\n")
      f.write("plot 'MSEfinal_40_15.dat' u 1:8 w l notitle ls 1,\\\n")
      f.write("'MSEfinal_40_15_para.dat' u 1:8 w l notitle ls 2\n")

   if i==9:
      f.write("set title 'hidden-hidden'\n")
      f.write("plot 'MSEfinal_40_15.dat' u 1:10 w l notitle ls 1,\\\n")
      f.write("'MSEfinal_40_15_para.dat' u 1:10 w l notitle ls 2\n")
